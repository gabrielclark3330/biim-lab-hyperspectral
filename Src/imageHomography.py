...
class transform():
    def __init__(self, vector, homography):
        self.vector = vector
...
for imageIndex in range(len(images)-1):
    transformArr.append(getTransfromImgs(images[imageIndex], images[imageIndex+1]))
...
cube_file = readDataCube('..\\data\\decoupledLeaf.cube')
